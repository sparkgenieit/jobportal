    ...
    <BrowserRouter>
      <GeneralProvider>
        <Routes>
          ...
          <Route path="/company/transactions/download-transactions"
            element={(role == 'employer') ?
          ...
          <Route path="/company/*" element={(role == 'employer' || role === "recruiter") ?
            <Suspense fallback={<Loader />}>
              <CompanyLayout />
            </Suspense>
            : <Navigate to="/" />}
          ...
          <Route path="/superadmin/*" element={(role == 'superadmin') ?
            <Suspense fallback={<Loader />}>
              <SuperAdminLayout />
            </Suspense>
            : <SuperAdminLogin />} />
