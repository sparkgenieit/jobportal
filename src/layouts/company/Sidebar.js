          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/company/CompanyProfile">
                ...
                <div className='mx-5 bg-lite'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
              ...
              <ul class="nav sub-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="/company/JobList">
                    ...
                    <div className='mx-5 bg-lite'><svg xmlns="http://www.w3.org/2000/svg" width="120" height="20" fill="currentColor" class="bi bi-view-list" viewBox="0 0 16 16">
