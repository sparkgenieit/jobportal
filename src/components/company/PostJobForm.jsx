...
import { salaryPerAnnum, validateIsNotEmpty } from '../../helpers/functions/textFunctions';
import MdxEditor from '../MdxEditor';
import { fetchCategories } from '../../services/company/postAndEditJob.service';
import { getCloseDate } from '../../helpers/functions';

export default function PostjobForm({ showButton, btnOnClick, btnText, initialValues, onFormSubmit }) {
    ...
    const submitJob = async () => {
        ...
        let requiredFields = ["company", "jobtype", "location", "numberofvacancies", "jobTitle", "jobCategory", "subCategory", "duration", "description"]
        ...
        for (const fieldName of requiredFields) {
            if (!validateIsNotEmpty(jobData[fieldName])) {
        ...
        if (isFormValid) {
            ...
            //After validating all the fields give the data to the parent component to perform furthur operations
            onFormSubmit(data)
        }
    }
