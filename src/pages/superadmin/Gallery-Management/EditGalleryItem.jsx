        ...
        <div className="col-md-9">
          <div className="form-group row">
            ...
            <div className="col-sm-9">
              ...
              />
              {error.thumb && <div className="text-danger">Please enter thumbnail URL</div>}
           {form.thumb && (
  <img
    src={form.thumb.startsWith('http') ? form.thumb : `${BASE_API_URL}${form.thumb}`}
    className="mt-2"
    height="100"
    alt="preview"
  />
        ...
        <div className="col-md-9">
          <div className="form-group row">
            ...
            <div className="col-sm-9">
              ...
              />
              {error.full && <div className="text-danger">Please enter full image URL</div>}
            </div>
          </div>
        </div>
        ...
        <div className="col-md-9">
          <div className="form-group row">
            ...
            <div className="col-sm-9">
              ...
              />
              {error.location && <div className="text-danger">Please enter location</div>}
            </div>
          </div>
        </div>
        ...
        <div className="col-md-9">
          <div className="form-group row">
            ...
            <div className="col-sm-9">
              ...
              />
              {error.category && <div className="text-danger">Please enter category</div>}
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-md-9">
            <button type="button" onClick={handleSubmit} className="btn btn-gradient-primary">Save</button>
