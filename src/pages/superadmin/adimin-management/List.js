      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row ">
              <div className="">
                <button type="button" className="btn btn-primary float-end mb-1  "><a href="Create" style={{ textDecoration: "none", color: "white" }}>Add</a></button>
              </div>
              <div class="col-12">
                          ...
                          <tbody className='text-center'>
                            {
                              list.map((list, index) => {
                                return <tr key={index}>
                                  ...
                                  <td>{list.password}</td>
                                  <td>
                                    <button type="button" class="btn btn-white btn-xs border m-1"><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="13" class="bi bi-pencil" viewBox="0 0 16 16">
