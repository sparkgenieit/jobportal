                          ...
                          <div className="col-sm-3">
                            ...
                            <div class="col-sm-5">
                              <div class="form-check">
                                ...
                                <input type="checkbox" class="form-check-input" name="jobtypeCheckbox" id="fullTime" checked={jobType.fullTime} value="option2" onChange={(event) => jobtypes("fullTime", event)} /> FullTime
                              </div>
                            </div>
                            ...
                            <div class="col-sm-5">
                              <div class="form-check">
                                ...
                                <input type="checkbox" class="form-check-input" name="jobtypeCheckbox" id="casual"checked={jobType.casual} value="option2" onChange={(event) => jobtypes("casual", event)} /> Casual
                              </div>
                            </div>
                            ...
                            <div class="col-sm-5">
                              <div class="form-check">
                                ...
                                <input type="checkbox" class="form-check-input" name="jobtypeCheckbox" id="freelance"checked={jobType.freelance} value="option2" onChange={(event) => jobtypes("freelance", event)} /> Freelance
                              </div>
                            </div>
                          ...
                          <div className="col-md-6">
                            ...
                            <div class="col-sm-5 mx-3">
                              <div class="form-check">
                                ...
                                <input type="checkbox" class="form-check-input" name="jobtypeCheckbox" id="partTime"checked={jobType.partTime} value="option2" onChange={(event) => jobtypes("partTime", event)} /> PartTime
                              </div>
                            </div>
                            ...
                            <div class="col-sm-5 mx-3">
                              <div class="form-check">
                                ...
                                <input type="checkbox" class="form-check-input" name="jobtypeCheckbox" id="contract"checked={jobType.contract} value="option2"onChange={(event) => jobtypes("contract", event)} /> Contract
                              </div>
                            </div>
                            ...
                            <div class="col-sm-5 mx-3">
                              <div class="form-check">
                                ...
                                <input type="checkbox" class="form-check-input" name="jobtypeCheckbox" id="temporary"checked={jobType.temporary} value="option2"onChange={(event) => jobtypes("temporary", event)} /> Temporary
                              </div>
                            </div>


                          </div>
                          { error &&<div className='mx-auto col-6 text-danger'>{error}</div>}
                        </div>
                      </div>
                      ...
                      <div className="form-group row">
                        ...
                        <div className=" row mx-4 ">
                          ...
                          <div className="col-2">
                            <div className="form-check">
                              <input type="checkbox" className="form-check-input" name="workinghoursRadio"
                                id="workinghoursRadio1" value="option3" onChange={(event) => Benifits('Food', event)} />Food
                            </div>
                          ...
                          <div className="col-3">
                            <div className="form-check">
                              <input type="checkbox" className="form-check-input" name="workinghoursRadio"
                                id="workinghoursRadio1" value="option3" onChange={(event) => Benifits('Transport', event)} />Transport
                            </div>
                          </div>
                          <div className="col-4 ">
                            <div className="form-check">
