                                                        ...
                                                        {assignJobs && assignJobs.length > 0 &&
                                                            assignJobs.map((job, index) => {
                                                                return <tr key={index}>
                                                                    ...
                                                                    <td>
                                                                        <a href={`/company/editjob/${job._id}`} type="button" disabled={isLoading} class="btn btn-outline-info btn-xs ">
                                                                    ...
                                                                    <td>
                                                                        <button type="button" class="btn  btn-xs btn-outline-danger" disabled={isLoading} onClick={() => handleDelete(job)}>
