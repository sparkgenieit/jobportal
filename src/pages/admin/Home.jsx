        ...
        <div className="row">
          <div className="col-md-4 stretch-card grid-margin">
            <div className="card bg-gradient-danger card-img-holder text-white">
              <div className="card-body">
                ...
                <h4 className="font-weight-normal mb-3">Total Jobs <i className="mdi mdi-chart-line mdi-24px float-right"></i>
                </h4>
          ...
          <div className="col-md-4 stretch-card grid-margin">
            <div className="card bg-gradient-info card-img-holder text-white">
              <div className="card-body">
                <img src="assets/images/dashboard/circle.svg" className="card-img-absolute" alt="circle-image" />
                <h4 className="font-weight-normal mb-3">Selected Canditates<i className="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                </h4>
