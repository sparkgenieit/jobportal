                                ...
                                <div className="row">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-6 px-2 d-flex align-items-center">
                                            <input type="radio" className="mx-2" checked={availability} value={availability} onChange={(event) => chnageOut("availability", event)} />
                                            Immediately
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-12">
                                        <div className="form-group row">
                                            <div className="col-md-4">
                                                <input type="checkbox" className="col-sm-12 form-check-input" name="jobtypeCheckbox" id="jobtypeCheckbox2" value="option2" checked={preferredJobTypes?.fullTime} onChange={(event) => preferredjobstypes("fullTime", event)} /> Full Time
                                            </div>
                                            <div className="col-md-4">
                                                <input type="checkbox" className="col-sm-11 form-check-input" name="jobtypeCheckbox" id="jobtypeCheckbox2" value="option2" checked={preferredJobTypes?.partTime} onChange={(event) => preferredjobstypes("partTime", event)} /> Part Time
                                            </div>
                                            <div className="col-md-4">
                                                <input type="checkbox" className="col-sm-11 form-check-input" name="jobtypeCheckbox" id="jobtypeCheckbox2" value="option2" checked={preferredJobTypes?.casual} onChange={(event) => preferredjobstypes("casual", event)} /> Casual
                                            </div>
                                            <div className="col-md-4">
                                                <input type="checkbox" className="col-sm-11 form-check-input" name="jobtypeCheckbox" id="jobtypeCheckbox2" value="option2" checked={preferredJobTypes?.contract} onChange={(event) => preferredjobstypes("contract", event)} /> Contract
                                            </div>
                                            <div className="col-md-4">
                                                <input type="checkbox" className="col-sm-11 form-check-input" name="jobtypeCheckbox" id="jobtypeCheckbox2" value="option2" checked={preferredJobTypes?.freelance} onChange={(event) => preferredjobstypes("freelance", event)} /> Freelance
                                            </div>
                                            <div className="col-md-4">
                                                <input type="checkbox" className="col-sm-12 form-check-input" name="jobtypeCheckbox" id="jobtypeCheckbox2" value="option2" checked={preferredJobTypes?.temporary} onChange={(event) => preferredjobstypes("temporary", event)} /> Temporary
                                            </div>
                                        </div>
                                    </div>
                                </div>}
                                    ...
                                    <div className="col-md-9">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                ...
                                                {errors?.showProfile && <div className="small text-danger"> {showprofileError}</div>}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row">
                                    <div className="col-md-9">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-7">
                                                <Input type="file" id="coverLetter" className="form-control" onChange={onFileChange} error={errors?.coverLetter} />
