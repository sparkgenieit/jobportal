                ...
                <div className="content-wrapper px-0 bg-white">
                    ...
                    <Pagination itemsPerPage={itemsPerPage} currentPage={pgNumber} setCurrentPage={setPgNumber} totalCount={totalItems} fetchItems={showJobsList} pageNumberToShow={2}>
                        <div className="bg-white rounded ">
                            ...
                            {!isLoading && jobs && <DataTable dataType={'Job'} jobs={jobs} handleDuplicate={handleDuplicate} closeAction={closeJob} handleDelete={handleDelete} getAppliedUsers={getAppliedUsers} goToEdit={goToEdit} />}
                        </div>
                    </Pagination>
                </div>
            </div>
